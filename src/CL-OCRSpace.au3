...
#AutoIt3Wrapper_Icon=F:\Autoit Cool\Projects\Translator\Safaricom\Examples\icons8-ocr-48.ico
...
#AutoIt3Wrapper_Res_Fileversion=1.0.1.68
...
; Setup Properties via Bool Switchs/Keys
...
If $b_gOCROverlayRequired And IsArray($sText_Detected) Then         ; return array data
	; Parsing the array ..
	; use a Requested Info Delimiter
...
Func HelpInfo()
	...
	Local $sHelpString = _
			...
			"                       [/dm]]" & @CRLF & _
			"Options  " & @CRLF & _
			"   -h   Print help information." & @CRLF & _
			"   -v   Print the version number." & @CRLF & _
